                    ...
                    <div class="x_panel" style="height:100%;">
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    {!! Form::select('teste', $teste_combo, Input::old('teste'), ['class' => 'form-control select2_single','placeholder' => 'Selecione']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    {!! Form::text('data_corte_teste', Input::old('data_corte_teste'), array('class' => 'form-control', 'id' => 'data_corte_teste', 'data-date-format' => 'dd/mm/yyyy', 'data-date-viewmode' => 'years')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    {!! Form::select('ams', $ams_combo, Input::old('ams'), ['class' => 'form-control select2_single','placeholder' => 'Selecione']) !!}
                                </div>
                            </div>
